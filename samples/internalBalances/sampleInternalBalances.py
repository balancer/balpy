...
def main():
    ...
    bal.erc20AsyncEnforceSufficientVaultAllowances(
        tokens, allowances, amounts, gasFactor, gasPriceSpeed
    )

    # QUERY INTERNAL BALANCE(S)
    bal.balVaultGetInternalBalance(tokens)
    ...
    bal.balVaultDoManageUserBalance(
        bal.UserBalanceOpKind["DEPOSIT_INTERNAL"],
        token,
        amount,
        bal.address,
        bal.address,
    ...
    bal.balVaultDoManageUserBalance(
        bal.UserBalanceOpKind["TRANSFER_INTERNAL"],
        token,
        amount,
        bal.address,
        deadAddress,
    ...
    bal.balVaultDoManageUserBalance(
        bal.UserBalanceOpKind["TRANSFER_EXTERNAL"],
        token,
        amount,
        bal.address,
        deadAddress,
