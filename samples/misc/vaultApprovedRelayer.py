...
def main():
    ...
    print("Before set approved relayer:", bal.balVaultHasApprovedRelayer(userAddress, userAddress))
    print()
    ...
    print("After unset approved relayer:", bal.balVaultHasApprovedRelayer(userAddress, userAddress))
    print()
